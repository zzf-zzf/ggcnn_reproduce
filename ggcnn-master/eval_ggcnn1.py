...
from utils.dataset_processing import evaluation1, grasp1
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for idx, (x, y, didx, rot, zoom) in enumerate(test_data):
            ...
            if args.iou_eval:
                s = evaluation1.calculate_iou_match(q_img, ang_img, test_data.dataset.get_gtbb(didx, rot, zoom),
            ...
            if args.jacquard_output:
                grasps = grasp1.detect_grasps(q_img, ang_img, width_img=width_img, no_grasps=1)
            ...
            if args.vis:
                evaluation1.plot_output(test_data.dataset.get_rgb(didx, rot, zoom, normalise=False),
